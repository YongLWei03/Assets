...
public partial class DeviceRepairManage : System.Web.UI.Page
{
    ...
    protected void BtnQuery_Click(object sender, EventArgs e)
    {
        ...
        this.GridView1.DataSource = (new RepairInfo()).QueryRepairInfo(deviceName, deviceType, starttime, endtime);
